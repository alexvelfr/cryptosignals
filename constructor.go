...
func NewSignal(symbol, interval string, indicator SignalIndicator, notificator Notificator) Signal {
	switch indicator {
	case IndicatorMACD:
		return &signalMACD{symbol: symbol, interval: interval, indicator: indicator, notificator: notificator}
	}
	return nil
}
